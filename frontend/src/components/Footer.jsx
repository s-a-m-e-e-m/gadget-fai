    ...
    return (
        <footer className="bg-gray-900 text-white p-10 mt-10">
            <div className='flex flex-col sm:justify-between sm:flex-row gap-10 md:gap-50 mb-6'>
                <div className="">
                    <h2 className="text-xl font-bold">GadgifAI</h2>
                    <p className="text-gray-400">Your AI-powered gadget recommendation platform</p>
                </div>
            ...
            <span className="text-gray-400 text-md hover:text-white">© 2026 GadgifAI. All rights reserved.</span>
        </footer>
    )
}
